 ...
 *
 *      $Source: /srv/kcr/athena/zephyr/zwgc/tty_filter.c,v $
 *      $Author: jtkohl $
 *
...
static char rcsid_tty_filter_c[] = "$Header: /srv/kcr/athena/zephyr/zwgc/tty_filter.c,v 1.3 1989-11-08 16:24:34 jtkohl Exp $";
#endif
