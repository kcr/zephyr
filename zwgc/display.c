 ...
 *
 *      $Source: /srv/kcr/athena/zephyr/zwgc/display.c,v $
 *      $Author: ghudson $
 *
...
static char rcsid_display_c[] = "$Header: /srv/kcr/athena/zephyr/zwgc/display.c,v 1.3 1997-09-14 22:13:55 ghudson Exp $";
#endif
