 ...
 *
 *      $Source: /srv/kcr/athena/zephyr/zwgc/xselect.c,v $
 *      $Author: marc $
 *
...
static char rcsid_xselect_c[] = "$Header: /srv/kcr/athena/zephyr/zwgc/xselect.c,v 1.2 1989-11-02 01:58:14 marc Exp $";
#endif
