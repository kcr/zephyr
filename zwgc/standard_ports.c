 ...
 *
 *      $Source: /srv/kcr/athena/zephyr/zwgc/standard_ports.c,v $
 *      $Author: marc $
 *
...
static char rcsid_standard_ports_c[] = "$Header: /srv/kcr/athena/zephyr/zwgc/standard_ports.c,v 1.2 1989-11-02 01:57:20 marc Exp $";
#endif
