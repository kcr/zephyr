 ...
 *
 *      $Source: /srv/kcr/athena/zephyr/zwgc/browser.c,v $
 *      $Author: ghudson $
 *
...
static char rcsid_browser_c[] = "$Header: /srv/kcr/athena/zephyr/zwgc/browser.c,v 1.3 1997-09-14 22:13:48 ghudson Exp $";
#endif
