 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/string_dictionary_aux.c,v $
 *      $Author: ghudson $
 *
...
static char rcsid_string_dictionary_aux_c[] = "$Id: string_dictionary_aux.c,v 1.1 1995-06-30 21:53:02 ghudson Exp $";
#endif
