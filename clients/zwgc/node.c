 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/node.c,v $
 *      $Author: marc $
 *
...
static char rcsid_node_c[] = "$Header: /srv/kcr/locker/zephyr/clients/zwgc/node.c,v 1.2 1989-11-02 01:56:35 marc Exp $";
#endif
