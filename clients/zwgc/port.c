 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/port.c,v $
 *      $Author: marc $
 *
...
static char rcsid_port_c[] = "$Header: /srv/kcr/locker/zephyr/clients/zwgc/port.c,v 1.2 1989-11-02 01:57:02 marc Exp $";
#endif
