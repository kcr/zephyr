 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/browser.c,v $
 *      $Author: ghudson $
 *
...
static char rcsid_browser_c[] = "$Header: /srv/kcr/locker/zephyr/clients/zwgc/browser.c,v 1.3 1995-06-30 21:52:27 ghudson Exp $";
#endif
