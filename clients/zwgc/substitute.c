 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/substitute.c,v $
 *      $Author: marc $
 *
...
static char rcsid_substitute_c[] = "$Header: /srv/kcr/locker/zephyr/clients/zwgc/substitute.c,v 1.2 1989-11-02 01:57:32 marc Exp $";
#endif
