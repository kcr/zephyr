 ...
 *
 *      $Source: /srv/kcr/locker/zephyr/clients/zwgc/xselect.c,v $
 *      $Author: marc $
 *
...
static char rcsid_xselect_c[] = "$Header: /srv/kcr/locker/zephyr/clients/zwgc/xselect.c,v 1.3 1989-11-03 02:20:09 marc Exp $";
#endif
