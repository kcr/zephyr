 ...
 *
 *	$Source: /srv/kcr/athena/zephyr/lib/Attic/acl_files.c,v $
 *	$Author: jtkohl $
 *
...
#ifndef lint
static char rcsid_acl_files_c[] = "$Header: /srv/kcr/athena/zephyr/lib/Attic/acl_files.c,v 1.1 1988-11-14 11:27:50 jtkohl Exp $";
#endif lint
