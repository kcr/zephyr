 ...
 *
 *	$Source: /srv/kcr/locker/zephyr/server/uloc.c,v $
 *	$Author: jtkohl $
 *
...
#ifndef lint
static char rcsid_uloc_s_c[] = "$Header: /srv/kcr/locker/zephyr/server/uloc.c,v 1.11 1987-09-28 16:42:02 jtkohl Exp $";
#endif lint
